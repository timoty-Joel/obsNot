...
## Anchors  
In ReGex, anchors is used to check if  the matching symbols are starting or ending part of a string. Anchors has two type: the first is caret `^` that is used to check 
